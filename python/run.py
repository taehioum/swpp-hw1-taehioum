...
def main():
    ...
    malenames = {x[1]: x[0] for x in parsed_malenames} # (names: ranks) /made to dict for fast search
    femalenames = {x[1]: x[0] for x in parsed_femalenames} # (names: ranks) /made to dict for fast search
